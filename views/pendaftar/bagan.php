...
echo GridView::widget([
        ...
        'columns' => [
            ...
            [
            	...
            	'template'	=> '{atlet} {bagan} {juara}',
            	'buttons'	=> [
            		'atlet'	=> function ($url, $model) {
            			$url = Url::to(['/pendaftar/atlet', 'ev' => $_GET['ev'], 'kls' => $model->bagan_id]);
            			return Html::a('Lihat Atlet', $url, ['class' => 'btn btn-info']);
            		},
            		'bagan'	=> function ($url, $model) {
            			$url = Url::to(['', 'ev' => $_GET['ev'], 'kls' => $model->bagan_id]);
            			return Html::a('Lihat Drawing', $url, ['class' => 'btn btn-success']);
            		},
                    'juara' => function ($url, $model) {
                        $url = Url::to(['/pendaftar/juara', 'ev' => $_GET['ev'], 'kls' => $model->bagan_id]);
    ...
    echo "</br>".Html::a('Kembali', ['/event/view', 'id' => $_GET['ev']], ['class' => 'btn btn-success']);
?>